...
public class MainActivity extends AppCompatActivity {
    ...
    int dia, mes, año, i = 0;
    String[][] personas = new String[7][20];
    ...
    public void guardar(View view) {
        ...
        if ((eNombre.getText().toString().isEmpty()) || (eContraseña.getText().toString().isEmpty()) || (eRepita.getText().toString().isEmpty()) || (eCorreo.getText().toString().isEmpty())) {
            ...
            while (ok == 0){
                if(cont < 20) {
                    if (personas[0][cont].equals(nombre)) {
            ...
            if (st == 0) {
                ...
                resultado[0] = eNombre.getText().toString();
                resultado[1] = eContraseña.getText().toString();
                resultado[2] = eCorreo.getText().toString();
                intent.putExtra("nombre", resultado[0]);
                intent.putExtra("correo", resultado[2]);
                if (rMasculino.isChecked()) {
                    resultado[3] = "masculino";
                    intent.putExtra("sexo", resultado[3]);
                } else {
                    resultado[3] = "femenino";
                    intent.putExtra("sexo", resultado[3]);
                }
                fecha1 = String.valueOf(dia);
                fecha2 = String.valueOf(mes);
                fecha3 = String.valueOf(año);
                resultado[4] = dia + "/" + mes + "/" + año;
                intent.putExtra("fecha de nacimiento", resultado[4]);
                resultado[5] = sLugar.getSelectedItem().toString();
                intent.putExtra("lugar de nacimiento", resultado[5]);
                ...
                resultado[6] = hb.toString();
                intent.putExtra("hobbies", resultado[6]);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if((requestCode == 5678) && (resultCode == RESULT_OK)){
            if(data.hasExtra("contacto")){
                String[][] Nuevaspersonas = null;
                String sReceived = data.getExtras().getString("key_string");
                Object[] objectArray = (Object[]) data.getExtras().getSerializable("key_array_array");
                if (objectArray != null) {
                    Nuevaspersonas = new String[objectArray.length][];
                    for (int b = 0; b < objectArray.length; b++) {
                        Nuevaspersonas[b] = (String[]) objectArray[b];
                    }
                }
                for (int x = 0; x < 7; x++) {
                    for(int w = 0; w < 20; w++) {
                        personas[x][w] = Nuevaspersonas[x][w];
                    }
                }
                i--;
            }
    ...
    public void contactos(View view) {
        ...
        mBundle.putSerializable("key_array_array",  personas);
